...
public class x86InternalObject {
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".getRef")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".getSize")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".getID")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".getMem")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".getClassName")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".setRef")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".setSize")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".setID")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".setMem")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".destroy")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".int2obj")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".obj2int")
	public static void obj2int(F0xC fox, Parser86 parser, ArrayList<String> list, NodeCustom node) {
		list.add("mov reg0, "+F0xUtil.argS(0,1));
	}
	
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".obj2str")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".con2int")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".arr2int")
	...
	@OverrideTranslation(override = StringConfig86.class_InternalObject+".getContentSize")
