...
public class StringConfig86 {
	
	public static final String class_Internal = "pusty/f0xC/x86/internal/Internal";
	public static final String class_InternalObject = "pusty/f0xC/x86/internal/InternalObject";
