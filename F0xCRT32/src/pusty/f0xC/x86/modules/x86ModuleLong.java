...
public class x86ModuleLong extends F0xModule {
	...
	public static void nodeVARFIX_GLOBALLOAD(F0xEventNodeVarFixParsing event) {
		event.getCurrentList().add("mov reg0, addrname ["+F0xUtil.formatVariable(event.getNode().refferedBy())+"+addrsize]");
		event.getCurrentList().add("mov reg3, addrname ["+F0xUtil.formatVariable(event.getNode().refferedBy())+"]");
	}
	
	public static void nodeVARFIX_GLOBALSTORE(F0xEventNodeVarFixParsing event) {
		event.getCurrentList().add("mov addrname ["+F0xUtil.formatVariable(event.getNode().refferedBy())+"+addrsize], reg0");
		event.getCurrentList().add("mov addrname ["+F0xUtil.formatVariable(event.getNode().refferedBy())+"], reg3");
