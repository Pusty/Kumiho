...
public class x86ModuleDouble extends F0xModule {
	...
	public String getDoubleVarName(double f) {
	...
	public void addDoubleVar(double d) {
		doublemap.put(getDoubleVarName(d), d);
	}
	...
	public void nodeCONST_DOUBLE(F0xEventNodeConstParsing event) {
		...
		addDoubleVar(value);
		event.getCurrentList().add("mov reg3, addrname ["+getDoubleVarName(value)+"]");
		event.getCurrentList().add("mov reg0, addrname ["+getDoubleVarName(value)+"+addrsize]");
	}
